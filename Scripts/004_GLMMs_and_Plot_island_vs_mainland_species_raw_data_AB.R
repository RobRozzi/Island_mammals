...
island_sp_mainlandvsisland <- filter(island_sp_mainlandvsisland, Body_mass != "") # 3 species missing, is there no way to retrieve this info? Not for this submission, but during the review process
...
#Create BM bins
island_sp_mainlandvsisland$Body_mass <- as.numeric(island_sp_mainlandvsisland$Body_mass) # it's already numeric but ok

breaks <- c(0, 0.1, 1, 10, 100, 1000, 10000, 100000,1000000, 10000000, 100000000, 1000000000) # in grams
...
#order bins
BM_groups_extinct <- factor(group_tags_extinct, ordered = TRUE) # why do you do this? just for your personal info?
...
# why do this for the original dataset with the species names? 
