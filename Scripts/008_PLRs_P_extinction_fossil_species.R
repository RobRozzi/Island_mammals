...
ggsave(sensi_plot1, filename = "PLR_P(extinct)_vs_Magnitude_fossil_species_phylo_uncertainty_complete_trees_TACT.pdf", width = 6, height = 6, device = cairo_pdf)
...
#Save the table
gtsave(gt_tbl1, "Table_Summ_stats_PLR_P(extinct)_vs_Magnitude_fossil_species.html")
...
ggsave(sensi_plot2, filename = "PLR_P(extinct)_vs_Body_mass_fossil_species_phylo_uncertainty_complete_trees_TACT.pdf", width = 6, height = 6, device = cairo_pdf) 
...
#Save the table
gtsave(gt_tbl2, "Table_Summ_stats_PLR_P(extinct)_vs_Body_mass_fossil_species.html")
